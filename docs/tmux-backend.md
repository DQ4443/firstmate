...
- `treehouse` for pooling clean worktrees; `no-mistakes` for the validation pipeline; native GitHub CLI `gh`, `chrome-devtools-axi`, and `lavish-axi` for GitHub, browser, and rich-review operations.
