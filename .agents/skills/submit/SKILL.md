...
The evidence bar is Jim's E0 Assumed, E1 Ran, E2 Works-unit with mutation, E3 Works-live, E4 Independently reproduced by a non-author agent, and E5 Refute-survived, with CAUSAL (a preregistered control and stated sample count) kept as the orthogonal named requirement, not an E-level, and `data/operating-model/evidence-ladder.md` canonical.
