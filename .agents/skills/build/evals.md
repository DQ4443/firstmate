...
- [ ] The loop ledger carried every canonical field, exact active or passive mode, full decision records, proof records with E-level artifacts, and the preregistered before-and-after record.
...
- [ ] Passive mode stopped for unapproved spend, a genuinely new direction outside intent, an irreversible or outward action, a named blocker, a termination proposal, or a scope-creep cut, but did not stop for an ordinary in-intent recommended move.
- [ ] The standing mode choice defaulted to the current mode, changed only later rounds, and was persisted in the ledger.
...
- [ ] Evidence used E0 Assumed, E1 Ran, E2 Works-unit with mutation, E3 Works-live, E4 Independently reproduced by a non-author agent, and E5 Refute-survived, with CAUSAL (preregistered control and sample count) kept as the orthogonal named requirement, not an E-level.
