...
jq -n \
  ...
  '{requested_effort: $requested_effort, effective_effort: $effective_effort, routing_rationale: $routing_rationale, override_applied: $override_applied, ultra_gate_applied: $ultra_gate_applied, fallback_applied: $fallback_applied, parallel_lanes: $parallel_lanes, quota_state: $quota_state, quota_changed_routing: false}'
