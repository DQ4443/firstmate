...
- **Restart-proof** - all state lives on disk and in the active session backend (tmux today); kill the session anytime and the next one reconciles and carries on.
